...
559--595. The author-corrected v5 manuscript frozen in
`papers/he2022classic/paper.json` is the semantic authority; the publisher
version is retained as a comparison source.
...
/-- The exact v5 theorem proposition. This is a definition, not a
proved theorem. -/
