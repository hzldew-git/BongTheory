...
/-!
# Beli (2019), Lemma 7.9(ii): type-III case-7 source candidates
...
theorem lemma79_typeIII_right_halfGap_le_sourceHalfGap
...
candidate in the type-III case-7 interval. -/
theorem lemma79_typeIII_right_primary_le_sourcePrimary
    [Beli2006AlphaLaws.{u, v} K]
  ...
  have hgapOrder : a.order ⟨i.val, i.lt_large⟩ =
    ...
    rw [← a.orderSequence_entryOrZero_eq_order,
      ← b.orderSequence_entryOrZero_eq_order]
    exact horderEntry
  have hnextAlpha := beli2019Remark613_typeIII_targetRightAlpha_eq_one
