...
manuscripta math. 174 (2024), 559--595.  The author-corrected v5 manuscript is
the semantic authority for this formalization; the publisher version and
later arXiv copies are comparison material.
