...
-/
import Bong.Lattice.Omeara9328StepEightNormalizedCommonConditionII

/-! # Condition 93:28(iii) on the Step-8 common adjunction -/
...
/-- O'Meara 93:28(iii) survives the common saturated adjunction. -/
theorem commonConditionIII
