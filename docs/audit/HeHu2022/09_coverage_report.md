...
- Direct checked publisher-result endpoints: 19/47, comprising every numbered
...
- Section 3 coverage additionally includes Definitions 3.1, 3.4, and 3.6 and
  ...
  every defined Table 1 space; their explicit Table 2 identification remains
  the Proposition 3.7 obligation.
...
The strict direct proof ratio is therefore **19/47**. This is a bookkeeping
