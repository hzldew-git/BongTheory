...
conversion declarations, including the complete Lemmas 4.2 and 4.3 endpoints. The
...
equivalences explicitly; Lemmas 4.2 and 4.3 are now discharged, but Lemmas 4.4 and 4.5
