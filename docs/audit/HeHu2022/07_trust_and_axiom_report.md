...
conversion declarations, including the complete Lemmas 4.2--4.4 endpoints. The
...
equivalences explicitly; Lemmas 4.2 and 4.4 are now discharged, but Lemma 4.5
remains open, so the audit does not present it as the completed Theorem 4.1.
