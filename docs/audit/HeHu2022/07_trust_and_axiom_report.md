...
permitted.  The audit now includes the direct Section 2 endpoints as well as
the abstract maximal-testing theorem.  The unproved Theorem 1.1 target is not
disguised as an axiom.
