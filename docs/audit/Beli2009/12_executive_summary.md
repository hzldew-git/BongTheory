...
- Paper: Beli 2009/2010, exact PDF fixed in `00_audit_scope.md`.
- Formal baseline: `10e8c666bfda81dcac44332cd38f481d8d02e31a`.
- Core results reviewed: Theorems 3.1, 4.2, and the Section 5 dichotomy.
...
proof paths. Unsafe claim: every semantic mapping has already received
