...
| Lemma 6.7(i)--(ii) | `Bong.BONG.GoodBONG.heADC2025Lemma67i`, `heADC2025Lemma67ii` | `FULLY_FORMALIZED` / `PROVISIONAL_MATCH` at `b0f832e`; actual represented lattices, exact alpha alternatives and raw/capped equalities, both rank boundaries and e=1 independently reviewed; report 22; clean-kit CI and human approval pending |
