...
| Lemma 6.8(i)--(ii) | `Bong.Lattice.heADC2025Lemma68i`, `heADC2025Lemma68ii` | Each clause `FULLY_FORMALIZED` / `PROVISIONAL_MATCH` at `b624d40`; exact n=2/n>=4 boundaries; report 23; later report 24 raises the partial lemma to 4/6 clauses; own clean CI and human approval pending |
| Lemma 6.8(v)--(vi) | `Bong.Lattice.heADC2025Lemma68v`, `heADC2025Lemma68vi` and their `Published` wrappers | `FULLY_FORMALIZED` / `PROVISIONAL_MATCH` at `b728bce`; actual original-parameter lattice isometry, n=2 included; printed V domain explicitly requires compatible Delta in U; report 24; whole lemma 4/6, own clean CI and human approval pending |
