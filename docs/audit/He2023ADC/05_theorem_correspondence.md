...
| Lemma 6.8(i)--(ii) | `Bong.Lattice.heADC2025Lemma68i`, `heADC2025Lemma68ii` | Each clause `FULLY_FORMALIZED` / `PROVISIONAL_MATCH` at `b624d40`; arbitrary actual lattice, n=2 included in (i), n>=4 retained in (ii); report 23; whole lemma only 2/6 clauses; its own clean CI and human approval pending |
