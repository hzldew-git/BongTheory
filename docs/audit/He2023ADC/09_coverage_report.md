...
- Theorem 7.4 and Lemmas 7.5--7.10 and 7.12 are locally kernel-complete at
  ...
  and Definition 7.16 through Lemma 7.19 at `7b21fe0`, raising full Section 7
  coverage to 16/21 numbered items. The two Lemma 7.19 branches conclude on
  ...
  quantifier is recorded as a semantic mismatch. Reports 36--42 give the
...
Section 5, four still-unformalized Section 7 items, the printed-strength
