...
| Exact clean Review Kit through the publisher Table 1 certificate | PASS locally at clean checkpoint 8ead7f4: 2,064 payload hashes, a 5,569-job fresh-extraction build, all four direct gates, the 60,683-declaration enforcing gate, and the Mathematica Table 1 certificate pass; Report 60; later Reports 61--67 and GitHub release are separate |
