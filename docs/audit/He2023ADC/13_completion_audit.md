...
| Remaining non-dyadic Section 4 cases and printed-strength Lemma 7.13 | FAIL / pending; the symbolic Lemma 4.7 table data, Lemma 2.2, the dyadic unary boundary, and O'Meara 63:9 are no longer included here |
