...
| Non-dyadic Lemma 4.7(i) table data and Lemma 4.8 first sentence | PARTIAL PASS through ef4fcf4: all 16 symbolic block rows, total and Jordan ranks, table-level `J_{0,1}=N`, exact unary/binary definedness boundaries, and four-/seven-row counts are concrete and independently Mathematica-checked; actual lattice realization/classification and Lemma 4.8's representation equivalence remain pending; reports 61--62 |
...
| Remaining non-dyadic Section 4 cases and printed-strength Lemma 7.13 | FAIL / pending; the symbolic Lemma 4.7 table data, conditional deductions of Lemmas 4.7(ii), 4.14 and Propositions 4.15--4.16, Lemma 2.2, the dyadic unary boundary, and O'Meara 63:9 are no longer included here |
...
| Exact clean Review Kit through the publisher Table 1 certificate | PASS locally at clean checkpoint 8ead7f4: 2,064 payload hashes, a 5,569-job fresh-extraction build, all four direct gates, the 60,683-declaration enforcing gate, and the Mathematica Table 1 certificate pass; Report 60; later Reports 61--65 and GitHub release are separate |
