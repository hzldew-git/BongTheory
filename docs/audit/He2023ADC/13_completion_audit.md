...
| Unrestricted local cases, remaining Section 4 and Sections 5--8 | FAIL / pending |
...
| Clean Review Kit including later Proposition 4.13 | Pending its own exact-revision CI |
