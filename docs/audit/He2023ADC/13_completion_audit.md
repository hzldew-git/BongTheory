...
| Lemma 4.6, non-dyadic deduction | CONDITIONAL PASS through b2dba36: both actual-lattice parts and the maximal corollary are derived from the invariant proof of Lemma 4.5(i), target-pair facts, Proposition 4.2(iii), and transport; no ambient exactly-one or actual-lattice conclusion is a field; concrete local-field instance pending; reports 68 and 70 |
