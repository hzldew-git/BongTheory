...
| Lemma 4.6, non-dyadic deduction | CONDITIONAL PASS local kernel at b335b1f: both actual-lattice parts and the maximal corollary are derived from explicit Lemma 4.5(i), Proposition 4.2(iii), determinant, and transport laws; no final conclusion is a field; concrete local-field instance pending; report 68 |
