...
| Proposition 4.2(ii)--(iii) and Lemma 4.4, non-dyadic scope | CONDITIONAL PASS at ae494c5: table exhaustion, all three Lemma 4.4 biconditionals, representation of every nonexceptional space, failure on the named exception, and uniqueness of the excluding space are derived from a lower determinant--Hasse--Hilbert interface; concrete local-field instance pending; report 71 |
