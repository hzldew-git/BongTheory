...
| 7 | Theorems 7.1, 7.2; Remark 7.3; Theorem 7.4; Lemmas 7.5--7.15; Definition 7.16; Remark 7.17; Lemmas 7.18--7.20; Corollary 7.21 | 21 | Nine items are fully formalized: Theorems 7.1, 7.4 and Lemmas 7.5--7.10, 7.12. Lemma 7.11 has the odd-valuation specialization needed by Lemma 7.5 but not its full universal statement. Lemma 7.13 has a source mismatch: its proof establishes the formalized simultaneous-failure disjunction, not the stronger printed per-target conclusion. Ten items remain pending; reports 35--36 |
