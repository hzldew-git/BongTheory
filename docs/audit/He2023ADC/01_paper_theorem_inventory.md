...
| 6 | Theorems 6.1, 6.2; Remark 6.3; Lemmas 6.4--6.12 | 12 | Theorem 6.1, Lemma 6.4 (4/4 clauses), Lemma 6.5 (2/2) and Lemma 6.6 (2/2) pass local kernel and independent AI checks: 4/12 numbered items; exact-revision clean CI and human approval pending; the other eight items remain pending |
