...
| 6 | Theorems 6.1, 6.2; Remark 6.3; Lemmas 6.4--6.12 | 12 | Theorem 6.1, Lemmas 6.4--6.7, and Lemma 6.12 have complete local proofs: 6/12 numbered items. Lemma 6.12's actual exceptional quaternary lattice is 2-ADC, not 3-ADC, and nonmaximal; report 32 gives its source-first audit and pending clean-CI boundary. Lemma 6.8(i),(ii),(iii),(v),(vi) and n>=4 of (iv) are proved in their stated scopes. The printed n=2 part of (iv) is `SEMANTIC_MISMATCH`: reports 30--31 give an independently audited, concrete nonvacuous formal counterexample. Theorem 6.2 and Lemmas 6.9--6.11 remain unproved, and its printed proof route is affected by this mismatch |
