...
| 6 | Theorems 6.1, 6.2; Remark 6.3; Lemmas 6.4--6.12 | 12 | Theorem 6.1, Lemma 6.4 (4/4 clauses), and Lemmas 6.5--6.7 (2/2 each) pass local/independent checks and clean-kit CI at f6f7485/c82668b: 5/12 numbered items. Later Lemma 6.8(i)--(ii) is locally proved and AI-reviewed, only 2/6 clauses, with its own clean CI pending. Other scope and human approval remain open |
