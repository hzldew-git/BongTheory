...
| 6 | Theorems 6.1, 6.2; Remark 6.3; Lemmas 6.4--6.12 | 12 | Theorem 6.1, Lemma 6.4 (4/4 clauses), and Lemmas 6.5--6.7 (2/2 each) pass local kernel and independent AI checks: 5/12 numbered items; exact-revision clean CI and human approval pending; the other seven items remain pending |
