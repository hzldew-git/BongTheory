...
| 6 | Theorems 6.1, 6.2; Remark 6.3; Lemmas 6.4--6.12 | 12 | Theorem 6.1 and Lemmas 6.4--6.7 pass local/independent checks and clean-kit CI at f6f7485/c82668b: 5/12 numbered items. Later Lemma 6.8(i),(ii),(v),(vi) is locally proved and AI-reviewed through b728bce, only 4/6 clauses; the printed domain in (v),(vi) exposes Delta in U. Its own clean CI and human approval remain pending |
