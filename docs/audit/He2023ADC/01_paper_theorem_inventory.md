...
| 6 | Theorems 6.1, 6.2; Remark 6.3; Lemmas 6.4--6.12 | 12 | Theorem 6.1 and Lemmas 6.4--6.7, 6.9--6.12 have complete local proofs: 9/12 numbered items. Reports 32--33 give the source-first audits of the exceptional lattice and Lemmas 6.9--6.11. Lemma 6.8(i),(ii),(iii),(v),(vi) and n>=4 of (iv) are proved in their stated scopes. The printed n=2 part of (iv) is `SEMANTIC_MISMATCH`: reports 30--31 give an independently audited, concrete nonvacuous formal counterexample. Theorem 6.2 and Remark 6.3 remain pending, and the printed proof route to Theorem 6.2 is affected by the mismatch |
