...
| 6 | Theorems 6.1, 6.2; Remark 6.3; Lemmas 6.4--6.12 | 12 | Theorem 6.1 and Lemmas 6.4--6.7 pass local/independent checks and clean-kit CI at f6f7485/c82668b: 5/12 numbered items. Later Lemma 6.8(i),(ii),(iii),(v),(vi), plus n>=4 of (iv), is locally proved and AI-reviewed through 074f2cd: 5/6 whole clauses. The n=2 case of (iv) remains open; (v),(vi) expose Delta in U. Its own clean CI and human approval remain pending |
