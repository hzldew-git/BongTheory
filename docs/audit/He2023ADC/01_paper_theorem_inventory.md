...
| 6 | Theorems 6.1, 6.2; Remark 6.3; Lemmas 6.4--6.12 | 12 | Lemma 6.4 (4/4 clauses) and Lemma 6.5 (2/2 clauses) pass local kernel and independent AI checks; exact-revision clean CI and human approval pending; the other ten numbered items remain pending |
