...
| Lemma 8.1; Proposition 8.2; Lemma 8.3 | the `he2022ClassicLemma81*` endpoints, `Proposition82Laws.he2022ClassicProposition82_positive`, the two `SectionEightLaws` Proposition 8.2 wrappers, `HeClassic2024NumberFieldGlobalData.sectionEightLaws`, and `he2022ClassicLemma83_even` | `CONDITIONAL_FORMALIZATION`: Proposition 8.2 is derived from the source's lower globalization/localization steps (Report 27); the standard number-field arithmetic fields are derived from a place equivalence (Report 36); Lemma 8.3 is retained only for `n >= 2` even (Report 28); concrete lattice instances and the odd branch remain pending |
