...
| Theorem 1.5 | `Bong.BONG.GoodBONG.he2022ClassicTheorem15_allRanks`, `HeightOneSpectrumIdentification.numberFieldDiscriminantBridge`, `HeClassic2024GlobalData.SectionEightLaws.he2022ClassicTheorem15_discriminantOdd` | local implication fully proved for n >= 1; the discriminant theorem and finite-place bridge coverage are proved (Reports 32 and 34); the concrete global lattice/localization model and compatibility statements remain |
