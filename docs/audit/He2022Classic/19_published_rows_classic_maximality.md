...
Historical checkpoint: the statement below that this result does not close
odd testing predates author-corrected v5. Report 22 records the later closure;
the maximality results themselves remain current.
