...
| He classic Section 8 and Theorems 1.7--1.9 | Lemma 8.1, Proposition 8.2, even Lemma 8.3/Theorem 1.8, and the remaining global deductions | conditional source logic proved from explicit number-field, extension, and strong-approximation packages; Proposition 8.2, Theorem 1.9's local-to-global step, and the ramified-place witness are derived from lower laws; concrete instances remain, and no unrestricted odd Lemma 8.3/Theorem 1.8 endpoint is exported; Classic Reports 23--30 |
