...
| He classic, Corollary 6.3 | `Bong.BONG.GoodBONG.he2022ClassicCorollary63_even`, `Bong.BONG.exists_he2022ClassicCorollary63_odd_counterexample` | `Bong/Bong/He2022ClassicCorollary63.lean`, `Bong/Bong/He2022ClassicCorollary63OddCounterexample.lean` | `EVEN_BRANCH_PROVED_ODD_STATEMENT_REFUTED_AT_E2_N3` |
...
| He classic, Theorem 1.3 odd literal minimality, author-corrected v5 | `Bong.he2022ClassicTheorem13_odd_literalMinimal_v5` | `Bong/Bong/He2022ClassicLemma711.lean` | `FULLY_FORMALIZED_PROVISIONAL_MATCH` |
| He classic, Lemma 7.1, author-corrected v5 | `Bong.BONG.GoodBONG.he2022ClassicLemma71v5_lowDefect_represents`, `Bong.BONG.GoodBONG.he2022ClassicLemma71v5_ramificationOne_represents`, `Bong.BONG.GoodBONG.he2022ClassicLemma71v5_C1OneModel_represents_evenHOneModel` | `Bong/Bong/He2022ClassicLemma71V5.lean` | `FULLY_FORMALIZED_PROVISIONAL_MATCH` |
| He classic, Lemma 7.4 odd branch, author-corrected v5 | `Bong.Lattice.QuadraticLatticeModel.he2022ClassicLemma74_odd_v5` | `Bong/Bong/He2022ClassicSectionSeven.lean` | `FULLY_FORMALIZED_PROVISIONAL_MATCH` |
| He classic, Lemma 8.1 and Proposition 8.2 | `Bong.HeClassic2024NumberFieldLocalExtension.completionAdicOrder_liesOver`, `completionQuadraticDefect_scale`, `completionGoodBONGCoefficients_map`, `completionLemma81Laws`, `Bong.HeClassic2024NumberFieldBONGBridge.goodBONG_mappedValues_haveRealization`, `Bong.HeClassic2024LocalExtensionData.Lemma81Laws.he2022ClassicLemma81i`, `he2022ClassicLemma81ii`, `he2022ClassicLemma81iii`, `Bong.HeClassic2024GlobalData.Proposition82Laws.he2022ClassicProposition82_positive` | `Bong/Lattice/He2022ClassicNumberFieldLocalExtension.lean`, `Bong/Lattice/He2022ClassicNumberFieldBONGBridge.lean`, `Bong/Lattice/He2022ClassicSectionEight.lean` | `MIXED`; Lemma 8.1(i)--(ii) and an actual upper good-BONG realization with the mapped values are concrete; literal part (iii) remains open because the v5 proof does not identify that realization with its preassigned localized scalar-extension lattice; Proposition 8.2 is derived from lower globalization/localization laws |
| He classic, Theorem 1.5 global deduction | `Bong.HeClassic2024NumberField.discriminantOdd_iff_forall_ramificationIdx_eq_one`, `Bong.HeClassic2024NumberFieldGlobalData.sectionEightLaws`, `Bong.HeClassic2024GlobalData.SectionEightLaws.he2022ClassicTheorem15_discriminantOdd` | `Bong/Lattice/He2022ClassicNumberFieldDiscriminant.lean`, `Bong/Lattice/He2022ClassicSectionEight.lean`, `Bong/Lattice/He2022ClassicNumberFieldGlobalData.lean` | `CONDITIONAL_FORMALIZATION`; the discriminant theorem and all arithmetic compatibility fields are concrete once a place equivalence is supplied; the global lattice/localization model, that equivalence, and the remaining lattice laws remain |
| He classic, Lemma 8.3 and Theorems 1.7--1.9 | `Bong.HeClassic2024ExtensionData.Lemma83Laws.he2022ClassicLemma83_even`, `he2022ClassicTheorem18_even`, `Bong.HeClassic2024NumberField.exists_dyadicPrime_ramificationIdx_ne_one_of_not_discriminantOdd`, `Bong.HeClassic2024GlobalData.SectionEightLaws.he2022ClassicTheorem17_of_localAdjacentDefectsLarge`, `he2022ClassicTheorem17_even`, `HeClassic2024GlobalData.SumOfSquaresLocalUniversalityLaws.sumOfSquares_localUniversal_of_oddDiscriminant`, `HeClassic2024GlobalData.SumOfSquaresLocalGlobalLaws.sumOfSquares_local_to_global`, `he2022ClassicTheorem19` | `Bong/Lattice/He2022ClassicNumberFieldDiscriminant.lean`, `Bong/Lattice/He2022ClassicSectionEight.lean` | `CONDITIONAL_FORMALIZATION`; the discriminant theorem is concrete; Lemma 8.3, Theorem 1.7, and Theorem 1.8 have explicit `n >= 2` even endpoints; the rank-independent final contradiction for Theorem 1.7 is also available with its missing local-defect calculation as a premise; Theorem 1.9 finite-place and local-to-global steps are derived from lower laws; no unrestricted odd endpoint is exported |
| He classic, Lemma 7.11 odd row deletion | `Bong.he2022ClassicLemma711_publishedOdd_deletionWitness` | `Bong/Bong/He2022ClassicLemma711.lean` | `FULLY_FORMALIZED_PROVISIONAL_MATCH` |
| He classic, Lemma 7.10(iii), C-row witness core | `Bong.BONG.GoodBONG.he2022ClassicLemma710iii_largeC1_represents_other`, `Bong.BONG.GoodBONG.he2022ClassicLemma710iii_largeC2_represents_other` | `Bong/Bong/He2022ClassicLemma710.lean` | `FULLY_FORMALIZED_CORE_PARTIAL_TABLE_CLAUSE` |
