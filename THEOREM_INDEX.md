...
| He classic, Theorem 1.5 global deduction | `Bong.HeClassic2024GlobalData.DiscriminantRamificationLaws.discriminantOdd_of_unramified`, `Bong.HeClassic2024GlobalData.SectionEightLaws.he2022ClassicTheorem15_discriminantOdd` | `Bong/Lattice/He2022ClassicSectionEight.lean` | `CONDITIONAL_FORMALIZATION`; only the required discriminant direction is assumed |
| He classic, Lemma 8.3 and Theorems 1.7--1.9 | `Bong.HeClassic2024ExtensionData.Lemma83Laws.he2022ClassicLemma83_even`, `he2022ClassicTheorem18_even`, `Bong.HeClassic2024GlobalData.DiscriminantRamificationLaws.exists_ramifiedDyadic_of_not_discriminantOdd`, `Bong.HeClassic2024GlobalData.SectionEightLaws.he2022ClassicTheorem17`, `HeClassic2024GlobalData.SumOfSquaresLocalUniversalityLaws.sumOfSquares_localUniversal_of_oddDiscriminant`, `HeClassic2024GlobalData.SumOfSquaresLocalGlobalLaws.sumOfSquares_local_to_global`, `he2022ClassicTheorem19` | `Bong/Lattice/He2022ClassicSectionEight.lean` | `CONDITIONAL_FORMALIZATION`; Lemma 8.3 and Theorem 1.8 only for `n >= 2` even; Theorem 1.9 finite-place and local-to-global steps and Theorem 1.7 ramified-place witness are derived from lower laws; Theorem 1.7 lacks its written odd calculation |
