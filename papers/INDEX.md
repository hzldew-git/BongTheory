...
He Classic uses the author-corrected v5 manuscript and records the publisher
and arXiv files as comparison sources. Its current v5 checkpoint is not a
release candidate: audit Reports 24 and 26 refute the unrestricted odd clause
of Corollary 6.3; Lemma 8.3 and Theorem 1.8 require a source repair.
